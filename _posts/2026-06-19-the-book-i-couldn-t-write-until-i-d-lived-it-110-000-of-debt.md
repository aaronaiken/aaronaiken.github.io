---
layout: post
title: "The book I couldn't write until I'd lived it — $110,000 of debt"
...
**[Splinched](https://aaronaiken.me/splinched)** is the book I wrote about all of it. The story behind the system, the method that runs it, and a full working toolkit I can give to those who need it.
...
- **The book** — just over 120 pages (~2.5 hour reading time), my voice, the story and the method.
- **The Projection & Sandbox app** — model your debt-free date and play with the what-ifs: an extra monthly attack, some side income, a windfall. Runs in your browser. Nothing leaves your device. This was an absolute game changer for me when I saw the reality, and then used the sandbox to see what was needed to hit my goal date. [You can play with it using demo data now if you'd like. ](https://aaronaiken.me/splinched/projection/)
- **The Ledger Spreadsheet** — the spreadsheet version of my private app. No coding. This helps to keep an eye on your total balance due, your cash runway, interest burn, recurring and known expenses, etc. 
- **The Leak-Hunt app** — drop in a bank CSV and surface the recurring charges you forgot you were paying. Also browser-only; nothing gets uploaded. [Take a look now using demo data.](https://aaronaiken.me/splinched/leak-hunt/)
- **The Milestone Worksheet** and a **Daily Practice Card** for payday sessions.
...
[**Read the first two chapters, free →**](https://aaronaiken.me/splinched)
...
[**Get the bundle — Founder $19 →**](https://aaronaiken.me/splinched)
