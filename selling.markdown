...
description: I take what a business needs and turn it into something that actually works. Custom tools, automation, and operating cadence for small teams. Direct engagements only.
---

I take what a business needs and turn it into something that works. Not a prototype, not a wireframe, not a slide deck — an actual running thing that does what you asked it to do.
...
Send me a note via [the contact page](/contact/) with what you're trying to do and roughly when. Even a paragraph is enough — you don't need to know what to call it, how it should work, or what it's built with. Plain language is fine. Plain language is preferred.
