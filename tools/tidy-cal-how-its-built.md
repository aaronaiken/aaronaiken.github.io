...
description: How TidyGlance works and how it's built — a locale-correct month grid in your menu bar, no permissions.
breadcrumb:
...
TidyGlance puts the month one glance away. Click the date in your menu bar and a clean grid drops down — today highlighted, the week starting on the right day for where you are. No app to launch, no window to manage, no permissions to grant.
...
TidyGlance is the light answer. The month, right there, the instant you click — and then it's gone again. It does one small thing that you do a dozen times a day, and it does it without ceremony.
...
**Permissions:** None. TidyGlance draws a calendar; it asks for nothing. That's the point — it's the free, no-questions front door to the rest of the family.
