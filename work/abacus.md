...
{% include work_interest.html heading="Need an operational hub like this?" blurb="Abacus was built for one camp's exact workflow, but the shape — one live roster with everything that hangs off it — fits a lot of programs. If you're running something on spreadsheets and group texts, tell me what it needs to do." %}
