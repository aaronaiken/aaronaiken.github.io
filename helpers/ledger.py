...
def cash_runway(conn):
	...
	# Obligation window is half-open: [today, next_payday). Anything
	# dated on payday itself is covered by that day's incoming paycheck
	# and shouldn't count against pre-payday runway.
